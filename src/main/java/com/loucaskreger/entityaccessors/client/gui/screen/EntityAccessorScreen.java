...
public class EntityAccessorScreen extends ContainerScreen<EntityAccessorContainer> {

	public static LivingEntity entity;
	private static final ResourceLocation TEXTURE = new ResourceLocation(EntityAccessors.MOD_ID,
			"textures/gui/entityaccessor.png");
	// the previous mouseX and mouseY
	private float prevMouseX;
	private float prevMouseY;

	public EntityAccessorScreen(EntityAccessorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
